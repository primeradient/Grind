...
public class AmountToWords {
    ...
    private String getAmountInWords(long amount) {
        ...
        for (int i = 0; i < places.length; i++) {
            ...
            if (qty > 0) {
                String toAdd = "";
                if (qty > 10) {
                    toAdd = getAmountInWords(qty) + "-" + place.name;
                } else {
    ...
    public int solve(String A, String B) {
        ...
        String b = getAmountInWords(amount);
    ...
    public static void main(String args[]) {
        System.out.println(new AmountToWords().solve("987654", "nine-lakh-eighty-seven-thousand-six-hundred-and-fifty-four"));
        //
    }
